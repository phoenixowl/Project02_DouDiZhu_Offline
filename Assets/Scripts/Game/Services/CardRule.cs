...
namespace DouDiZhu.Logic.Services
{
    ...
    public static class CardRule
    {
        ...
        public static void AnalyzeCardGroup(List<Card> inputCards, CardGroup group)
        {
            ...
            List<Card> sortedDisplayCards = SortCardsByWeights(inputCards, rankCounts, type);
        ...
        /// </summary>
        private static List<Card> SortCardsByWeights(List<Card> input, Dictionary<int, int> counts, CardType type)
        {
        ...
        public static bool CanBeat(CardGroup target, CardGroup baseGroup)
        {
            ...
            if (baseGroup.Type == CardType.Invalid) return true;
